(ns counterpoint.third-species-examples
  (:require [counterpoint.cantus :refer [get-melody]]
            ...
            [counterpoint.third-species-patterns :refer [asc-pt-skip3-leap-to
                                                         asc-pt-skip3-to
                                                         cambiata-to desc-pt-neighbor-to desc-pt-skip-desc-3-to diss-3-asc-neighbor-to
                                                         ending-1 skip-4-asc-pt-to]]))
 ...
 (make-third-species
  ...
  (reduce
   ...
   [(reverse (asc-pt-to :c n/a4)) ;; pt asc
    ...
    [n/d4]]) :above))(ns counterpoint.third-species-examples
                       (:require [counterpoint.cantus :refer [get-melody]]
                                 [counterpoint.cantus-firmi-examples :refer [fux-d fux-e fux-f]]
                                 [counterpoint.first-species :refer [make-first-species]]
                                 [counterpoint.lilypond :refer [species->lily]]
                                 ...
                                 [counterpoint.second-species :refer [make-second-species]]
                                 [counterpoint.third-species :refer [make-third-species]]
                                 [counterpoint.third-species-patterns :refer [cambiata-to
                                                                              desc-pt-neighbor-to
                                                                              diss-3-asc-neighbor-to ending-1 skip-4-asc-pt-to]]))
